...
void sendConfigToESP2() {
  ...
  String topic = String(MQTT_ROOT_TOPIC_PREFIX) + FILE_UPLOAD_TOPIC_PREFIX + "/upload/start";
...
void sendFileStatus(int fileIndex) {
  ...
  String topic = String(MQTT_ROOT_TOPIC_PREFIX) + FILE_UPLOAD_TOPIC_PREFIX + "/upload/" + String(uploadData.session_id) + "/status";
